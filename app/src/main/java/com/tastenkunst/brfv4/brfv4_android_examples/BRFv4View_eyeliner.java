...
public class BRFv4View_eyeliner extends FrameLayout {
	...
	public BRFv4View_eyeliner(Context context) {
		super(context);
	}

	public BRFv4View_eyeliner(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//
		...
		_example = new track_single_face_eyeliner(getContext());			// "basic - face tracking - track single face"
