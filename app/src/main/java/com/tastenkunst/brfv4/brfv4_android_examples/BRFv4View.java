...
import brfv4.examples.face_detection.detect_smaller_faces;
import brfv4.examples.face_tracking.blink_detection;
import brfv4.examples.face_tracking.color_libs;
import brfv4.examples.face_tracking.smile_detection;
import brfv4.examples.face_tracking.track_single_face;
import brfv4.examples.face_tracking.track_single_face_eyebrow;
import brfv4.examples.face_tracking.track_single_face_eyeliner;
import brfv4.examples.face_tracking.track_single_face_eyeshadow;
import brfv4.examples.face_tracking.track_single_face_lips;
import brfv4.examples.face_tracking.yawn_detection;
...
public class BRFv4View extends FrameLayout {
	...
	public BRFv4View(Context context, String type) {
		super(context);
		this.type = type;
	}
...
//		_example = new track_multiple_points(getContext());		// "basic - point tracking - track multiple points"
		/*if (type.equalsIgnoreCase("0"))              // "basic - point tracking - track points and face"
			_example = new track_points_and_face(getContext());
		else if (type.equalsIgnoreCase("1"))
			_example = new track_single_face_lips(getContext());
		else if (type.equalsIgnoreCase("2"))
			_example = new track_single_face_eyebrow(getContext());
		else if (type.equalsIgnoreCase("3"))
			_example = new track_single_face_eyeshadow(getContext());
		else if (type.equalsIgnoreCase("4"))
			_example = new track_single_face_eyeliner(getContext());
		else if (type.equalsIgnoreCase("5"))
			_example = new track_single_face(getContext());*/
