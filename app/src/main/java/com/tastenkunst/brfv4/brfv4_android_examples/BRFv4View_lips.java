...
public class BRFv4View_lips extends FrameLayout {
	...
	public BRFv4View_lips(Context context, ArrayList<String> type) {
		super(context);
		this.type = type;
	}

	public BRFv4View_lips(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//
		...
		_example = new track_single_face_lips(getContext(), type);			// "basic - face tracking - track single face"
