...
public class BRFv4View_eyeblink extends FrameLayout {
	...
	public BRFv4View_eyeblink(Context context) {
		super(context);
	}

	public BRFv4View_eyeblink(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
