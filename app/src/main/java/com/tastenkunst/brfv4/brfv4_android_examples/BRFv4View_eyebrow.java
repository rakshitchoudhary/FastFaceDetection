...
public class BRFv4View_eyebrow extends FrameLayout {
	...
	public BRFv4View_eyebrow(Context context) {
		super(context);
	}

	public BRFv4View_eyebrow(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//
		...
		_example = new track_single_face_eyebrow(getContext());			// "basic - face tracking - track single face"
