...
public class BRFv4View_eyeshadow extends FrameLayout {
	...
	public BRFv4View_eyeshadow(Context context) {
		super(context);
	}

	public BRFv4View_eyeshadow(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
...
//
		...
		_example = new track_single_face_eyeshadow(getContext());			// "basic - face tracking - track single face"
